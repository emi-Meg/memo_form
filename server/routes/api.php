...
Route::get('total-memo-sent/{id}', [UserController::class, 'totalMemoSent'])->name('total.memo.sent');
Route::get('total-memo-received/{id}', [UserController::class, 'totalMemoReceived'])->name('total.memo.received');
...
Route::group(['middleware' => ['role:approver,User,BranchHead,Creator']], function () {
