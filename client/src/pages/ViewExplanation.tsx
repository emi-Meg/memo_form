...
import ViewExplanationModal from "../components/Modals/ViewExplanationModal";
type Props = {};
...
const ViewExplanation = (props: Props) => {
  ...
  useEffect(() => {
    if (userId) {
      ...
      axios
        .get(`http://localhost:8000/api/explain/for-approval/${userId}`, {
          headers,
        })
        .then((response) => {
